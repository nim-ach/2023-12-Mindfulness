...
Main results are represented in the Figure X.

Fig. X. Diagram of main results.

****Insertar Figura resumen resultados****

Footnote: The figure represents the main results of this study. Blue arrows and boxes represent the correlation between variables, while orange arrows and boxes represent the factors mediating the above correlations. "+" means that the mediating factor enhances the main observed effect, contrary to "-", reflecting a diminished main effect when considering the mediating factor.
