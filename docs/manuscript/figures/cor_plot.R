...
## Select variables
ind <- c(GDS = "gds_total", BAI = "bai_total", MOCA = "moca_total", HSPS = "hsps_total", SPPB = "sppb_total",
         ...
         LF = "hrv_lf_peri", HF = "hrv_hf_peri",  PNS = "hrv_pns_peri", SNS = "hrv_sns_peri", Stress = "hrv_stress_peri")
...
jpeg("docs/manuscript/figures/fig-1.jpeg", width = 1080*2.5, height = 1080*2.5, res = 350)
eval(fig)
dev.off()
